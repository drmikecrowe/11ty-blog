...
- **Part 1:** [MCP Servers, Ports, and Sharing - Setting up the foundation](/posts/2025/2025-08-20-1-mcp-servers-ports-and-sharing/)
- **Part 2:** [ESLint Configuration Refactoring - Cleaning up tooling with AI](/posts/2025/2025-08-19-2-blog-post-llm-eslint-config/)
- **Part 3:** [Custom Architectural Rules - Teaching AI to enforce design patterns](/posts/2025/2025-08-18-3-blog-post-llm-eslint-tailwind/)
- **Part 4:** [Task Orchestration - Managing complex refactoring workflows](/posts/2025/2025-08-17-4-blog-post-task-orchestration/)
- **Part 5:** [Project Rules for AI - Creating effective memory banks and guidelines](/posts/2025/2025-08-16-5-project-rules-for-ai/)
- **Part 6:** [The Ultimate Design Review - Putting it all together](/posts/2025/2025-08-15-6-ai-detailed-project-reviews/)
...
- **[Design Review Feedback Example](/posts/2025/2025-09-06-1-design-review-feedback/)** - See the comprehensive analysis that the AI generates, including architectural strengths, critical issues, and detailed findings across all layers of the codebase.

- **[Design Review Action Items Example](/posts/2025/2025-09-06-2-design-review-action-items/)** - See how the AI transforms the analysis into a structured, actionable backlog with 18 major tasks and 72 subtasks, each with clear implementation steps and acceptance criteria.

These examples show the real output from running this system on an actual codebase. The AI identified critical architectural violations, generated specific improvement tasks, and created a comprehensive project plan - all automatically.
